...
export const Toolbar = ({
    ...
    useEffect(() => {
        ...
        const newFillColor = editor.getActiveFillColor();
        const newStrokeColor = editor.getActiveStrokeColor();
        const newFontFamily = editor.getActiveFontFamily();
        const newFontWeight = editor.getActiveFontWeight() || FONT_WEIGHT;
        const newFontStyle = editor.getActiveFontStyle();
